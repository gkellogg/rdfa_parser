...
describe "Literals" do
  ...
  describe "valid N3/NTriples format strings" do
    ...
    it "should return quoted string with language" do
      ...
      g.xml_args.should == ["tom", {"xml:lang" => "en"}]
    end
    ...
    it "should quote integer" do
      ...
      typed_int.xml_args.should == ["5", {"rdf:datatype" => "http://www.w3.org/2001/XMLSchema#int"}]
    end
    ...
    it "should indicate typed string" do
      ...
      typed_string.xml_args.should == ["foo", {"rdf:datatype" => "http://www.w3.org/2001/XMLSchema#string"}]
    end
    
    it "should escape extended characters" do
      g = Literal.untyped("松本 后子")
      g.to_n3.should == "\"\\\u677E\\\u672C \\\u540E\\\u5B50\""
      g.xml_args.should == ["松本 后子", {}]
    end
  end
  ...
  describe "XML Literals" do
    ...
    it "should properly encode non-namespace literal" do
      ...
      f.to_ntriples.should == f.to_n3
      f.xml_args.should == ["foo <sup>bar</sup> baz!", {"rdf:parseType" => "Literal"}]
    end
    ...
    it "should add single namespace" do
      ...
      f.to_ntriples.should == f.to_n3
      f.xml_args.should == ["foo <sup xmlns:dc=\"http://purl.org/dc/elements/1.1/\">bar</sup> baz!", {"rdf:parseType" => "Literal"}]
    end
    ...
    it "should add default namespace" do
      ...
      f.to_ntriples.should == f.to_n3
      f.xml_args.should == ["foo <sup xmlns=\"http://purl.org/dc/elements/1.1/\">bar</sup> baz!", {"rdf:parseType" => "Literal"}]
    end
  ...
  it "should support XML Literals" do
    ...
    xml.xml_args.should == ["<b>foo</b>", {"rdf:parseType" => "Literal"}]
  end
